...
// Appointment for teeth protice
const pTeethProticeSchema = new Schema({
...
const PTeethProtice = mongoose.model("pTeethProtice", pTeethProticeSchema, "patients");
// export it to be use later
module.exports = PTeethProtice;
