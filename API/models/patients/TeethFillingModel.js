...
// Appointment for teeth filling
const pTeethFillingSchema = new Schema({
...
// const PTeethFilling = mongoose.model("patients", pTeethFillingSchema);
const PTeethFilling = mongoose.model("pTeethFilling", pTeethFillingSchema, "patients")
// export it to be use later
module.exports = PTeethFilling;
