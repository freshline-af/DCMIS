...
// Appointment for scaling
const pScalingSchema = new Schema({
...
// access the database collection = patients
const PScaling = mongoose.model("pScaling", pScalingSchema, "patients");
// export it to be use later
module.exports = PScaling;
