...
// Appointment for teeth remove
const pTeethRemoveSchema = new Schema({
...
const PTeethRemove = mongoose.model("pTeethRemove", pTeethRemoveSchema, "patients");
// export it to be use later
module.exports = PTeethRemove;
