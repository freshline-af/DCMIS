...
// Appointment for teeth cover
const pTeethCoverSchema = new Schema({
...
const PTeethCover = mongoose.model("pTeethCover", pTeethCoverSchema, "patients");
// export it to be use later
module.exports = PTeethCover;
